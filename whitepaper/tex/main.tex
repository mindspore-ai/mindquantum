...
\author{Zuoheng Zou}
\affiliation{organization}
\email{zouzuoheng2@huawei.com}
\author{Junyuan Zhou}
\affiliation{organization}
\email{zhoujunyuan1@huawei.com}
\author{Xu Zhou}
\affiliation{organization}
...
\begin{table}[ht]
    \begin{tabular}{|p{3cm}|p{3cm}|}
        ...
        Jiale Liu       & 2.4 \\
        Yanling Lin     & 2.5, 5.9 \\
        Xusheng Xu      & 1, 2.6, 3.1, 3.2, 3.3, 4.1, 6.1, 7, 8.1, 9 \\
...
We would like to thank all the contributors and users of \MindQuantum. It is the collective effort and attention of you that keeps this project going.
