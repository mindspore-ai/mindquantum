...
\lstset{
    stepnumber=0,
    literate=
        {¦}{{\textbar}}1 % Correctly render vertical bar
        {√}{{$\surd{}$}}1 % Correctly render square root
        {⟩}{{$\rangle$}}1  % Correctly render right angle bracket
}
\UseRawInputEncoding
...
View demo code of this chapter: \demonotebook{02}{chapt02} \ \demonotebookgithub{02}{chapt02}
...
View demo code of this chapter: \demonotebook{04}{chapt04} \ \demonotebookgithub{04}{chapt04}
