...
View demo code of this section: \democode{05}{5.3_Variational_Quantum_Eigensolver} \ \democodegithub{05}{5.3_Variational_Quantum_Eigensolver}
...
\end{lstlisting}
Based on \code{molecule}, we can use the function in \MindQuantum\ to obtain the corresponding qubit Hamiltonian formula,
\begin{lstlisting}
