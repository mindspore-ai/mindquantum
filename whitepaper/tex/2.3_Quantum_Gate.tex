...
In this section, we will introduce quantum gates and show how to use quantum gates in \MindQuantum. We classify quantum gates into three types: fixed quantum gates, parameterized quantum gates and custom quantum gates, and use the \code{on()} method to set the target qubits and control qubits. In addition, we also introduce how to quickly add control qubits to multiple quantum gates through the \code{controlled()} function.
