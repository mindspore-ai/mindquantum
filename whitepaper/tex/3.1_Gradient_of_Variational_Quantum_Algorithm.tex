...
The first step of VQA is to build a ansatz. In this task, we choose arbitrary single qubit rotation gate \U3 to work as ansatz and \U3 can also decompose into:
