Class mindquantum.framework.MQN2AnsatzOnlyOps(expectation_with_grad)

    MindQuantum算子，它得到由参数化量子电路（PQC）评估的量子态上哈密顿量期望绝对值的平方。此PQC应仅包含一个nsatz电路。此操作仅受`PYNT_MODE`支持。
