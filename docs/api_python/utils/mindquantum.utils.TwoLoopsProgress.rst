...
.. py:class:: mindquantum.utils.TwoLoopsProgress(n_outer_loop, n_inner_loop, outer_loop_name='Epoch', inner_loop_name='Batch')
    ...
    .. py:method:: update_inner_loop(loop_idx)
    ...
    .. py:method:: update_outer_loop(loop_idx)
