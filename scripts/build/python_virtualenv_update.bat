...
set critical_pkgs=pip "setuptools>=61,<=65.5.1;python_version<'3.12'" "setuptools>=61;python_version>='3.12'" "wheel==0.45.1" "pybind11>=2.9.2" "wheel-filename>1.2" "build==0.9.0"
