...
class Main(HybridModel):
    ...
    def build_grad_ops(self):
        ...
        ansatz += BarrierGate()
        ansatz += conv_circ('10', 7, 0)
        ansatz += conv_circ('11', 1, 2)
        ansatz += conv_circ('12', 3, 4)
        ansatz += conv_circ('13', 5, 6)
        ansatz += BarrierGate()
        ansatz += conv_circ('20', 1, 3)
        ansatz += conv_circ('21', 5, 7)
        ansatz += BarrierGate()
        ansatz += conv_circ('30', 7, 1)
        ansatz += conv_circ('31', 3, 5)
        ansatz += BarrierGate()
        ansatz += conv_circ('40', 3, 7)
