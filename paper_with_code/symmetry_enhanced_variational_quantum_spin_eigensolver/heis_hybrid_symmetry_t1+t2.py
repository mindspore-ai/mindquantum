...
def train_func(N,
    ...
    for layer in range(1, num_layer + 1):
        ...
        if layer == 1:
            init_params = (np.random.rand(len(circs[0].params_name)) -
                           .5) * np.pi
        else:
            init_params = joblib.load(
                'data/hardware_sym_t1+t2_Heis_params_run={}_N={}_layer={}_J={}'
        ...
        joblib.dump(
            loss_hist,
            'data/hardware_sym_t1+t2_Heis_expt_run={}_N={}_layer={}_J={}'.
        ...
        joblib.dump(
            fids_hist,
            'data/hardware_sym_t1+t2_Heis_fids_run={}_N={}_layer={}_J={}'.
            format(run, N, layer, J))
...
if __name__ == '__main__':
    ...
    target_state = [eigenstates[1], eigenstates[2]]
