...
"""
    ...
    References:
        Grgur Palle1 and Owen Benton. Exactly solvable spin-1/2 XYZ models 
            with highly-degenerate, partially ordered, ground states. arXiv:2101.12140v2
        Changlani et al. Macroscopically Degenerate Exactly Solvable Point
            in the Spin-1/2 Kagome Quantum Antiferromagnet. Phys.Rev.Lett. 120, 117202.
        Kentaro Sugimoto and Seiji Yunoki. Emergent long-range interaction and state-selective localization in a strongly driven XXZ model. arXiv:2103.16755v1
        Mykhailo V. Rakov and Michael Weyrauch. Spin-1/2 XXZ Heisenberg chain in a longitudinal magnetic field. Phys.Rev.B 100, 134434 (2019)
        Juan Jos ́e Mendoza-Arenas. Dynamical quantum phase transitions in the one-dimensional extended Fermi-Hubbard model. http://arxiv.org/abs/2109.07709v2
        Yariv Yanay et al. Two-dimensional hard-core Bose–Hubbard model with superconducting qubits. NPJ Quantum Information (2020) 6:58
        Details about Hubbard model see openfermion/hamiltonians/hubbard.py @ https://github.com/quantumlib/OpenFermion
"""
