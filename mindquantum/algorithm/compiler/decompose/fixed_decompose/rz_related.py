...
def crz_decompose(gate: gates.RZ):
    """
    Decompose controlled :class:`mindquantum.core.gates.RZ` gate.

    Args:
        gate (:class:`mindquantum.core.gates.RZ`): a :class:`mindquantum.core.gates.RZ` gate with one control qubits.
