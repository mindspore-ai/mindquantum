...
def get_H6_geo(bond_len):
    ...
    # return [('H', (0, 0, i * bond_len)) for i in range(8)]
    return geometry


def get_H8_geo(bond_len):
    return [('H', (i * bond_len, 0, 0)) for i in range(8)]


def get_H10_geo(bond_len):
    return [('H', (i * bond_len, 0, 0)) for i in range(10)]


def get_H12_geo(bond_len):
    return [('H', (i * bond_len, 0, 0)) for i in range(12)]
...
def get_CH4_geo(bond_len):
    ...
    coordinate_4 = (cos(109.5 / 180 * pi) * bond_len, cos(120 / 180 * pi) * sin(109.5 / 180 * pi) * bond_len,
                    sin(120 / 180 * pi) * sin(109.5 / 180 * pi) * bond_len)
    coordinate_5 = (cos(109.5 / 180 * pi) * bond_len, cos(120 / 180 * pi) * sin(109.5 / 180 * pi) * bond_len,
                    -sin(120 / 180 * pi) * sin(109.5 / 180 * pi) * bond_len)
