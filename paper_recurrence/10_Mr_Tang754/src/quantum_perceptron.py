...
class perceptron:
    ...
    def update(in_vector, w_vector, pred, input_dataset, weight_dataset):
        ...
        if pred == 1 and traing_label[in_vector]==1:
            ...
            for i in range(80):
                ...
                preds = perceptron.active_function(input_circuits, weight_circuits)  
                if preds == 0:
                    break
            try: 
                weight_circuits = weight_dataset[w_vector]
    ...
    @staticmethod
    def data_circuits(z_combinations, control_z_combinations,control_2_z_combinatons, control_3_z_combinations):
            ...
            for c_2_z_gate in control_2_z_combinatons:
                for c_z_gate in control_z_combinations:
                    for z_gate in z_combinations:
                        data_circuits_input.append(perceptron.Quantum_Hypergraph_cicuits(z_gate, c_z_gate, c_2_z_gate, c_3_z_gate,True))
                        data_circuits_weight.append(perceptron.Quantum_Hypergraph_cicuits(z_gate, c_z_gate, c_2_z_gate, c_3_z_gate, False))
