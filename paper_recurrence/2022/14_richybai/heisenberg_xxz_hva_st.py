...
if __name__ == "__main__":
    ...
    for num_qubits in num_qubits_list:
        ...
        for k in range(500):
            ...
            if (k + 1) % 50 == 0:
                print(
                    f"{num_qubits} qubits system random + transfer sampling {k+1} is finished"
                )
        ...
        for k in range(500):
            ...
            if (k + 1) % 50 == 0:
                print(
                    f"{num_qubits} qubits system transfer + random sampling {k+1} is finished"
                )
        ...
        for k in range(500):
            ...
            if (k + 1) % 50 == 0:
                print(
                    f"{num_qubits} qubits system transfer sampling {k+1} is finished"
                )
