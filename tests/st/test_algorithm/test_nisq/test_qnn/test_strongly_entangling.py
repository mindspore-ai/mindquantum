...
def test_strongly_entangling_ansatz():
    ...
    qs_exp = np.array([
        0.79707728 + 0.01013428j, -0.11230256 + 0.0640159j, -0.02478449 - 0.09007194j, 0.19063718 + 0.21396115j,
        0.05847713 + 0.11265412j, -0.00747775 + 0.16495718j, 0.25717824 + 0.29613843j, 0.22900849 + 0.08570448j
    ])
