...
bool mindquantum::details::load_cengine(pybind11::handle src, cengines::engine_t& engine) {
    ...
    if (type_name == "InstructionFilter" || type_name == "projectq.cengines._replacer._replacer.InstructionFilter") {
