...
auto transform_ladder_operator(const TermValue& value, const qlist_t& x1, const qlist_t& y1, const qlist_t& z1,
    ...
    auto coefficient_1 = coefficient_t(static_cast<typename fermion_op_t::coefficient_real_t>(0.5));
    auto coefficient_2 = coefficient_t(std::complex<typename fermion_op_t::coefficient_real_t>(0, -0.5));
