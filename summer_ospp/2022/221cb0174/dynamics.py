...
def make_circ_m(thetas, theta_i, theta_j, qcidx):
    ...
    apply_dic = {
        0: [RX(thetas[0]).on(3, 1)],
        1: [RX(thetas[1]).on(4, 2)],
        2: [X.on(4, 3), RZ(thetas[2]).on(4),
            X.on(4, 3)],
        3: [RX(thetas[3]).on(3)],
        4: [RX(thetas[4]).on(4)],
        5: [X.on(4, 3), RZ(thetas[5]).on(4),
            X.on(4, 3)]
    }
    ...
    apply_dic = {
        0: [RX(thetas[0]).on(7, 5)],
        1: [RX(thetas[1]).on(8, 6)],
        2: [X.on(8, 7), RZ(thetas[2]).on(8),
            X.on(8, 7)],
        3: [RX(thetas[3]).on(7)],
        4: [RX(thetas[4]).on(8)],
        5: [X.on(8, 7), RZ(thetas[5]).on(8),
            X.on(8, 7)]
    }
...
def make_circ_xx(thetas, theta_i, qcidx):
    ...
    apply_gates = {0: X.on(7), 1: Y.on(7), 2: X.on(8), 3: Y.on(8)}
...
def measure_z0(thetas):
    ...
    circ += H.on(1)
    apply_dic = {
        0: [RX(thetas[0]).on(2, 0)],
        1: [RX(thetas[1]).on(3, 1)],
        2: [X.on(3, 2), RZ(thetas[2]).on(3),
            X.on(3, 2)],
        3: [RX(thetas[3]).on(2)],
        4: [RX(thetas[4]).on(3)],
        5: [X.on(3, 2), RZ(thetas[5]).on(3),
            X.on(3, 2)]
    }
    for i in range(6):
        for i_op in apply_dic[i]:
