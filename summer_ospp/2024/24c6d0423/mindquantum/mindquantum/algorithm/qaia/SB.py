...
try:
    ...
    print(err)
    warnings.warn(
        f"Unable import bSB gpu backend. This could be due to your environment "
...
class BSB_HALF(SB):
    ...
    def update(self):
        ...
        if self.h is None:
            ...
            _qaia_sb.bsb_update_h_half(self.J, self.x, self.h, self.batch_size, self.xi, self.delta, self.dt, self.n_iter)
...
class BSB_INT8(SB):
    ...
    def update(self):
        ...
        if self.h is None:
            ...
            _qaia_sb.bsb_update_h_int8(self.J, self.x, self.h, self.batch_size, self.xi, self.delta, self.dt, self.n_iter)
...
class DSB_HALF(SB):
    ...
    def update(self):
        ...
        if self.h is None:
            ...
            _qaia_sb.dsb_update_h_half(self.J, self.x, self.h, self.batch_size, self.xi, self.delta, self.dt, self.n_iter)
...
class DSB_INT8(SB):
    ...
    def update(self):
        ...
        if self.h is None:
            ...
            _qaia_sb.dsb_update_h_int8(self.J, self.x, self.h, self.batch_size, self.xi, self.delta, self.dt, self.n_iter)