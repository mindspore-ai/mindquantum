...
def HeaVqe(n_qubits, sparse_q_ham, single_rot_gate_seq, entangle_gate,
    ...
    mol_pqc = sim.get_expectation_with_grad(sparse_q_ham, hea_circuit)
...
with open(os.path.join(
        os.getcwd(), r'data/mindquantum_parameters_{}.json'.format(mole_name)),
          'r+',
          newline='') as f:
    data = f.read()
